...
int ArmApiBase::get_reg_fp32_fp32(const uint8_t reg[5], float* txdate, int tx_n, float* rxdate,
                                  int rx_n)
{
    uint8_t data[4 * tx_n];
...
int ArmApiBase::get_reg_int8_fp32(const uint8_t reg[5], float* txdate, int tx_n, float* rxdate,
                                  int rx_n)
{
    uint8_t data[4 * tx_n];
    HexData::fp32_to_hex_big(txdate, data, tx_n);
 ...
 *                     Basic Api
 ************************************************************/
int ArmApiBase::get_axis(uint8_t* axis)
{
    return get_reg_int8(axis, reg_->UBOT_AXIS);
}

int ArmApiBase::get_uuid(uint8_t uuid[17])
{
    return get_reg_int8(uuid, reg_->UUID);
}

int ArmApiBase::get_sw_version(uint8_t version[20])
{
    return get_reg_int8(version, reg_->SW_VERSION);
}

int ArmApiBase::get_hw_version(uint8_t version[20])
{
    return get_reg_int8(version, reg_->HW_VERSION);
}

int ArmApiBase::get_sys_autorun(uint8_t* autorun)
{
    return get_reg_int8(autorun, reg_->SYS_AUTORUN);
}

int ArmApiBase::set_sys_autorun(uint8_t autorun)
{
    return set_reg_int8(&autorun, reg_->SYS_AUTORUN);
}

int ArmApiBase::shutdown_system(void)
{
    return set_reg_int8((uint8_t*)&reg_->SYS_SHUTDOWN[0], reg_->SYS_SHUTDOWN);
}

int ArmApiBase::reset_err(void)
{
    return set_reg_int8((uint8_t*)&reg_->RESET_ERR[0], reg_->RESET_ERR);
}

int ArmApiBase::reboot_system(void)
{
    return set_reg_int8((uint8_t*)&reg_->SYS_REBOOT[0], reg_->SYS_REBOOT);
}

int ArmApiBase::erase_parm(void)
{
    return set_reg_int8((uint8_t*)&reg_->ERASE_PARM[0], reg_->ERASE_PARM);
}

int ArmApiBase::saved_parm(void)
{
    return set_reg_int8((uint8_t*)&reg_->SAVED_PARM[0], reg_->SAVED_PARM);
}

/************************************************************
 *                     Control Api
 ************************************************************/
int ArmApiBase::get_motion_mode(uint8_t* mode)
{
    return get_reg_int8(mode, reg_->MOTION_MDOE);
}

int ArmApiBase::set_motion_mode(uint8_t mode)
{
    return set_reg_int8(&mode, reg_->MOTION_MDOE);
}

int ArmApiBase::into_motion_mode_pos(void)
{
    return set_motion_mode(0);
}

int ArmApiBase::into_motion_mode_teach(void)
{
    return set_motion_mode(2);
}

int ArmApiBase::get_motion_enable(int* able)
{
    return get_reg_int32(able, reg_->MOTION_ENABLE);
}
...
int ArmApiBase::into_motion_enable(void)
{
    return set_motion_enable(99, 1);
}

int ArmApiBase::into_motion_disable(void)
{
    return set_motion_enable(99, 0);
}

int ArmApiBase::get_brake_enable(int* able)
{
    return get_reg_int32(able, reg_->BRAKE_ENABLE);
}
...
int ArmApiBase::get_error_code(uint8_t* code)
{
    return get_reg_int8(code, reg_->ERROR_CODE);
}

int ArmApiBase::get_servo_msg(uint8_t* msg)
{
    return get_reg_int8(msg, reg_->SERVO_MSG);
}

int ArmApiBase::get_motion_status(uint8_t* status)
{
    return get_reg_int8(status, reg_->MOTION_STATUS);
}

int ArmApiBase::set_motion_status(uint8_t status)
{
    return set_reg_int8(&status, reg_->MOTION_STATUS);
}

int ArmApiBase::motion_status_into_stop(void)
{
    return set_motion_status(4);
}

int ArmApiBase::motion_status_into_ready(void)
{
    return set_motion_status(0);
}

int ArmApiBase::motion_status_into_pause(void)
{
    return set_motion_status(3);
}

int ArmApiBase::get_cmd_num(int* num)
{
    return get_reg_int32(num, reg_->CMD_NUM);
}

int ArmApiBase::set_cmd_num(int num)
{
    return set_reg_int32(&num, reg_->CMD_NUM);
}
...
int ArmApiBase::moveto_cartesian_lineb(float* mvpose, float mvvelo, float mvacc, float mvtime,
                                       float mvradii)
{
    float data[6 + 4];
    memcpy(data, mvpose, 6 * 4);
...
int ArmApiBase::moveto_cartesian_circle(float* pose1, float* pose2, float mvvelo, float mvacc,
                                        float mvtime, float percent)
{
    float data[16];
...
int ArmApiBase::moveto_cartesian_p2pb(void)
{
    return 0;
}
...
int ArmApiBase::moveto_joint_lineb(float* mvjoint, float mvvelo, float mvacc, float mvtime,
                                   float mvradii)
{
    float data[axis_ + 4];
    memcpy(data, mvjoint, axis_ * 4);
...
int ArmApiBase::moveto_joint_circle(float* mvjoint1, float* mvjoint2, float mvvelo, float mvacc,
                                    float mvtime, float percent)
{
...
int ArmApiBase::moveto_joint_p2pb(float* mvjoint, float mvvelo, float mvacc, float mvtime,
                                  float mvradii)
{
    float data[axis_ + 4];
    memcpy(data, mvjoint, axis_ * 4);
...
int ArmApiBase::move_sleep(float time)
{
    return set_reg_fp32(&time, reg_->MOVE_SLEEP);
}

int ArmApiBase::plan_sleep(float time)
{
    return set_reg_fp32(&time, reg_->PLAN_SLEEP);
}

/************************************************************
 *                     Parameter Api
 ************************************************************/
int ArmApiBase::get_tcp_jerk(float* jerk)
{
    return get_reg_fp32(jerk, reg_->TCP_JERK);
}

int ArmApiBase::set_tcp_jerk(float jerk)
{
    return set_reg_fp32(&jerk, reg_->TCP_JERK);
}

int ArmApiBase::get_tcp_maxacc(float* acc)
{
    return get_reg_fp32(acc, reg_->TCP_MAXACC);
}

int ArmApiBase::set_tcp_maxacc(float acc)
{
    return set_reg_fp32(&acc, reg_->TCP_MAXACC);
}

int ArmApiBase::get_joint_jerk(float* jerk)
{
    return get_reg_fp32(jerk, reg_->JOINT_JERK);
}

int ArmApiBase::set_joint_jerk(float jerk)
{
    return set_reg_fp32(&jerk, reg_->JOINT_JERK);
}

int ArmApiBase::get_joint_maxacc(float* acc)
{
    return get_reg_fp32(acc, reg_->JOINT_MAXACC);
}

int ArmApiBase::set_joint_maxacc(float acc)
{
    return set_reg_fp32(&acc, reg_->JOINT_MAXACC);
}

int ArmApiBase::get_tcp_offset(float* offset)
{
    return get_reg_fp32(offset, reg_->TCP_OFFSET, 6);
}

int ArmApiBase::set_tcp_offset(float* offset)
{
    return set_reg_fp32(offset, reg_->TCP_OFFSET, 6);
}

int ArmApiBase::get_tcp_load(float* load)
{
    return get_reg_fp32(load, reg_->LOAD_PARAM, 4);
}

int ArmApiBase::set_tcp_load(float* load)
{
    return set_reg_fp32(load, reg_->LOAD_PARAM, 4);
}

int ArmApiBase::get_gravity_dir(float* dir)
{
    return get_reg_fp32(dir, reg_->GRAVITY_DIR, 3);
}

int ArmApiBase::set_gravity_dir(float* dir)
{
    return set_reg_fp32(dir, reg_->GRAVITY_DIR, 3);
}

int ArmApiBase::get_collis_sens(uint8_t* sens)
{
    return get_reg_int8(sens, reg_->COLLIS_SENS);
}

int ArmApiBase::set_collis_sens(uint8_t sens)
{
    return set_reg_int8(&sens, reg_->COLLIS_SENS);
}

int ArmApiBase::get_teach_sens(uint8_t* sens)
{
    return get_reg_int8(sens, reg_->TEACH_SENS);
}

int ArmApiBase::set_teach_sens(uint8_t sens)
{
    return set_reg_int8(&sens, reg_->TEACH_SENS);
}

int ArmApiBase::get_limit_fun(int* fun)
{
    return get_reg_int32(fun, reg_->LIMIT_FUN);
}

int ArmApiBase::set_limit_fun(int fun)
{
    return set_reg_int32(&fun, reg_->LIMIT_FUN);
}
 ...
 *                     State Api
 ************************************************************/
int ArmApiBase::get_tcp_target_pos(float* pos)
{
    return get_reg_fp32(pos, reg_->TCP_POS_CURR, 6);
}

int ArmApiBase::get_tcp_actual_pos(float* pos)
{
    return 0;
}

int ArmApiBase::get_joint_target_pos(float* pos)
{
    return get_reg_fp32(pos, reg_->JOINT_POS_CURR, axis_);
}

int ArmApiBase::get_joint_actual_pos(float* pos)
{
    return 0;
}

int ArmApiBase::get_joint_target_vel(float* vel)
{
    return get_reg_fp32(vel, reg_->JOINT_VEL_CURR, axis_);
}

int ArmApiBase::get_joint_actual_vel(float* vel)
{
    return 0;
}
...
int ArmApiBase::get_fk(float* joints, float* pose)
{
    return get_reg_fp32_fp32(reg_->CAL_FK, joints, axis_, pose, 6);
}

int ArmApiBase::is_joint_limit(void)
{
    return 0;
}

int ArmApiBase::is_tcp_limit(void)
{
    return 0;
}
...
int ArmApiBase::get_utrc_int8n_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t* data,
                                   uint8_t rx_len)
{
...
int ArmApiBase::set_utrc_int8n_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t* data,
                                   uint8_t tx_len)
{
...
int ArmApiBase::set_utrc_int8n_que(uint8_t line, uint8_t id, uint8_t reg, uint8_t* data,
                                   uint8_t tx_len)
{
    uint8_t tx_data[4 + tx_len] = {line, id, reg, tx_len};
    memcpy(&tx_data[4], data, tx_len);
...
int ArmApiBase::set_pass_rs485_now(uint8_t line, uint8_t timeout_ms, uint8_t tx_len, uint8_t rx_len,
...
int ArmApiBase::get_utrc_u8float_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t num,
                                     float* value)
{
...
int ArmApiBase::set_utrc_u8float_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t num,
                                     float value)
{
...
int ArmApiBase::get_utrc_nfloat_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t num,
                                    float* value)
{
    uint8_t tx_data[4] = {line, id, reg, num};
    float rx_data[1 + num];
 ...
 *                     GPIO Api
 ************************************************************/
int ArmApiBase::get_gpio_in(uint8_t line, uint8_t id, int32_t* fun, int32_t* digit, int* adc_num,
                            float* adc_value)
{
...
int ArmApiBase::get_gpio_out(uint8_t line, uint8_t id, int32_t* fun, int32_t* digit, int* adc_num,
                             float* adc_value)
{
    uint8_t tx_data[2] = {line, id};
    pthread_mutex_lock(&mutex_);
...
int ArmApiBase::set_tgpio_digit_out(int value)
{
    return set_utrc_int32_now(2, 1, 0x13, value);
}

int ArmApiBase::get_tgpio_uuid(uint8_t* value)
{
    return get_utrc_int8n_now(2, 1, 0x01, value, 12);
}

int ArmApiBase::get_tgpio_sw_version(uint8_t* value)
{
    return get_utrc_int8n_now(2, 1, 0x02, value, 12);
}

int ArmApiBase::get_tgpio_hw_version(uint8_t* value)
{
    return get_utrc_int8n_now(2, 1, 0x03, value, 12);
}
...
int ArmApiBase::set_cgpio_digit_out(int value)
{
    return set_utrc_int32_now(3, 1, 0x13, value);
}

int ArmApiBase::get_cgpio_uuid(uint8_t* value)
{
    return get_utrc_int8n_now(3, 1, 0x01, value, 12);
}

int ArmApiBase::get_cgpio_sw_version(uint8_t* value)
{
    return get_utrc_int8n_now(3, 1, 0x02, value, 12);
}

int ArmApiBase::get_cgpio_hw_version(uint8_t* value)
{
    return get_utrc_int8n_now(3, 1, 0x03, value, 12);
}
