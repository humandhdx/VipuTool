    ...
    Component{
        ...
        Item {
                    ...
                    Column{
                        ...
                        Row{
                            ...
                            Button{
                                ...
                                height: 40
                                text: "执行下一个点位"
                                enabled: true//urtrobot_left.arm_connect&&!isComplete
                                onClicked: {
                        ...
                        Row{
                            ...
                            Button{
                                ...
                                enabled: urtrobot_left.arm_connect&&isComplete
                                onClicked: {
                                    var result=kinematiccalibqwrapper.add_mask_index_for_position_recorder()
                                    if(result){
                                        kinematiccalibqwrapper.joint_pos_index++
                                    }
                                }
            ...
            FileDialog {
                ...
                nameFilters: ["文本文件 (*.text)", "所有文件 (*)"]  // 文件类型过滤
                onAccepted: {
                    ...
                    kinematiccalibqwrapper.Updata_Planned_Robot_Pose(true,resource)
                }
                onRejected: {
