...
public:
    ...
    Q_INVOKABLE bool add_mask_index_for_position_recorder(uint32_t index_of_position_record);//标识错误点位
    Q_INVOKABLE bool remove_mask_index_for_position_recorder(uint32_t index_of_position_record);//取消标识错误点位
