...
UtRobotConfig::TestConfig UtRobotConfig::TestConfig_RobotLeft = {
    ...
    {
        //initial joint pos
        {91.910320*M_PI/180.0, 69.493276*M_PI/180.0, -90.623914*M_PI/180.0, -124.103321*M_PI/180.0, -27.947194*M_PI/180.0, 59.642553*M_PI/180.0, 119.9*M_PI/180.0},
        //mid cartesian poses
        {
        ...
        //finiah joint pos
        {85.1*M_PI/180.0, 78.1*M_PI/180.0, -118.6*M_PI/180.0, -93.3*M_PI/180.0, -11.2*M_PI/180.0, -8.1*M_PI/180.0, 61.7*M_PI/180.0}
    },
    /* accracy test */
    {
        //initial joint pos
