...
public:
    enum CameraCalib_Type{
        ...
        LOCAL_CAMERA_LEFT_ARM_LEFT      = 7,
        LOCAL_CAMERA_LEFT_ARM_RIGHT     = 8,
        LOCAL_CAMERA_LEFT_ARM_DUEL      = 9,
    };
    ...
    Q_INVOKABLE bool updata_Joint_Pos_Local_Left_LeftEye(QString source_file_path);
    Q_INVOKABLE bool updata_Joint_Pos_Local_Left_RightEye(QString source_file_path);
    Q_INVOKABLE bool updata_Joint_Pos_Local_Left_DuelEye(QString source_file_path);
    ...
    Q_PROPERTY( int joint_pos_index_local_left_LeftEye READ joint_pos_index_local_left_LeftEye WRITE set_joint_pos_index_local_left_LeftEye NOTIFY joint_pos_index_local_left_LeftEye_Changed FINAL)
    Q_PROPERTY( int joint_pos_total_num_local_left_LeftEye READ joint_pos_total_num_local_left_LeftEye WRITE set_joint_pos_total_num_local_left_LeftEye NOTIFY joint_pos_total_num_local_left_LeftEye_Changed FINAL)
    Q_PROPERTY( QVariantList current_joint_pos_local_left_LeftEye READ get_current_joint_pos_local_left_LeftEye WRITE set_current_joint_pos_local_left_LeftEye NOTIFY current_joint_pos_local_left_LeftEye_changed)

    Q_PROPERTY( int joint_pos_index_local_left_RightEye READ joint_pos_index_local_left_RightEye WRITE set_joint_pos_index_local_left_RightEye NOTIFY joint_pos_index_local_left_RightEye_Changed FINAL)
    Q_PROPERTY( int joint_pos_total_num_local_left_RightEye READ joint_pos_total_num_local_left_RightEye WRITE set_joint_pos_total_num_local_left_RightEye NOTIFY joint_pos_total_num_local_left_RightEye_Changed FINAL)
    Q_PROPERTY( QVariantList current_joint_pos_local_left_RightEye READ get_current_joint_pos_local_left_RightEye WRITE set_current_joint_pos_local_left_RightEye NOTIFY current_joint_pos_local_left_RightEye_changed)

    Q_PROPERTY( int joint_pos_index_local_left_DuelEye READ joint_pos_index_local_left_DuelEye WRITE set_joint_pos_index_local_left_DuelEye NOTIFY joint_pos_index_local_left_DuelEye_Changed FINAL)
    Q_PROPERTY( int joint_pos_total_num_local_left_DuelEye READ joint_pos_total_num_local_left_DuelEye WRITE set_joint_pos_total_num_local_left_DuelEye NOTIFY joint_pos_total_num_local_left_DuelEye_Changed FINAL)
    Q_PROPERTY( QVariantList current_joint_pos_local_left_DuelEye READ get_current_joint_pos_local_left_DuelEye WRITE set_current_joint_pos_local_left_DuelEye NOTIFY current_joint_pos_local_left_DuelEye_changed)
    ...
    int joint_pos_index_local_left_LeftEye() const;
    void set_joint_pos_index_local_left_LeftEye(int newJoint_pos_index_local_left_LeftEye);

    int joint_pos_total_num_local_left_LeftEye() const;
    void set_joint_pos_total_num_local_left_LeftEye(int newJoint_pos_total_num_local_left_LeftEye);

    QVariantList get_current_joint_pos_local_left_LeftEye() const;
    void set_current_joint_pos_local_left_LeftEye(const QVariantList &newCurrent_joint_pos_local_left_LeftEye);

    int joint_pos_index_local_left_RightEye() const;
    void set_joint_pos_index_local_left_RightEye(int newJoint_pos_index_local_left_RightEye);

    int joint_pos_total_num_local_left_RightEye() const;
    void set_joint_pos_total_num_local_left_RightEye(int newJoint_pos_total_num_local_left_RightEye);

    QVariantList get_current_joint_pos_local_left_RightEye() const;
    void set_current_joint_pos_local_left_RightEye(const QVariantList &newCurrent_joint_pos_local_left_RightEye);

    int joint_pos_index_local_left_DuelEye() const;
    void set_joint_pos_index_local_left_DuelEye(int newJoint_pos_index_local_left_DuelEye);

    int joint_pos_total_num_local_left_DuelEye() const;
    void set_joint_pos_total_num_local_left_DuelEye(int newJoint_pos_total_num_local_left_DuelEye);

    QVariantList get_current_joint_pos_local_left_DuelEye() const;
    void set_current_joint_pos_local_left_DuelEye(const QVariantList &newCurrent_joint_pos_local_left_DuelEye);
...
signals:
    ...
    void joint_pos_index_local_left_LeftEye_Changed();

    void joint_pos_total_num_local_left_LeftEye_Changed();

    void current_joint_pos_local_left_LeftEye_changed();

    void joint_pos_index_local_left_RightEye_Changed();

    void joint_pos_total_num_local_left_RightEye_Changed();

    void current_joint_pos_local_left_RightEye_changed();

    void joint_pos_index_local_left_DuelEye_Changed();

    void joint_pos_total_num_local_left_DuelEye_Changed();

    void current_joint_pos_local_left_DuelEye_changed();
...
private:
    ...
    std::vector<std::vector<double>> vector2d_jpos_list_local_left_LeftEye_;
    std::vector<std::vector<double>> vector2d_jpos_list_local_left_RightEye_;
    std::vector<std::vector<double>> vector2d_jpos_list_local_left_DuelEye_;
    ...
    int m_joint_pos_index_local_left_LeftEye;
    int m_joint_pos_total_num_local_left_LeftEye;
    QVariantList m_current_joint_pos_local_left_LeftEye;
    int m_joint_pos_index_local_left_RightEye;
    int m_joint_pos_total_num_local_left_RightEye;
    QVariantList m_current_joint_pos_local_left_RightEye;
    int m_joint_pos_index_local_left_DuelEye;
    int m_joint_pos_total_num_local_left_DuelEye;
    QVariantList m_current_joint_pos_local_left_DuelEye;
};
