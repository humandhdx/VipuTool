...
Item {
    Column{
        ...
        Button{
            ...
            text: "局部相机标定"
            onClicked: {
               pageLoader.sourceComponent=local
            }
        }
        Button{
            width: 200
    ...
    Component{
        ...
        Item {
            ...
            property int right_captureCount: 0
            Component.onCompleted: {
                capturePath=cameraManager.currentDirectory()+"/Local_Calibration/Binocular"
                binocular_left_capturePath=cameraManager.currentDirectory()+"/Local_Calibration/Binocular/Left"
                binocular_right_capturePath=cameraManager.currentDirectory()+"/Local_Calibration/Binocular/Right"
                left_capturePath=cameraManager.currentDirectory()+"/Local_Calibration/Left"
                right_capturePath=cameraManager.currentDirectory()+"/Local_Calibration/Right"
                cameraManager.clearCaptureCount(binocular_left_capturePath)
                cameraManager.clearCaptureCount(binocular_right_capturePath)
                cameraManager.clearCaptureCount(left_capturePath)
                cameraManager.clearCaptureCount(right_capturePath)
                        ...
                        Row{
                            ...
                            Button{
                                ...
                                onClicked: {
                                    ...
                                    mask.open()
                                    left_captureCount++
                                    cameraManager.start_camera_capture(left_capturePath,4,left_captureCount)
                                    mask.close()
                                }
                            }
                            Item {
                        ...
                        Row{
                            ...
                            Button{
                                ...
                                onClicked: {
                                    mask.open()
                                    captureCount++
                                    cameraManager.start_camera_capture(binocular_left_capturePath,4,captureCount)
                                    cameraManager.start_camera_capture(binocular_right_capturePath,5,captureCount)
                                    mask.close()
                                }
                            }
                            Item {
                            ...
                            Button{
                                ...
                                onClicked: {
                                    ...
                                    mask.open()
                                    right_captureCount++
                                    cameraManager.start_camera_capture(right_capturePath,5,right_captureCount)
                                    mask.close()
                                }
                            }
                            Item {
